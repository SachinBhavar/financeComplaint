...
```
export AIRFLOW_HOME="/home/sachin/census_consumer_project/census_consumer_complaint/airflow"
```
...
```
airflow users create  -e bhavarsachin@gmail.com -f Sachin -l Bhavar -p admin -r Admin  -u admin
```
To start scheduler
```
airflow scheduler
